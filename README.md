...
API-шки в своем широком понимании применяются для обеспечения работы модели [Клиент - Сервер](https://en.wikipedia.org/wiki/Client%E2%80%93server_model) локально или по сети для повторного применения пользовательских типов данных и методов работы с ними в исходных текстах (функции, интерфейсы, статические и динамические библиотеки) разной степени гибкости

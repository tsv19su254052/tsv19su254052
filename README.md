...
API-шки в своем широм понимании применяются для обеспечения работы клиентов с серверными компонентами, а также для повторного применению исходных текстов в библиотеках и пользовательских типах данных

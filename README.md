...
Суммируя обращения к документации по `GitHub`-у и учитывая некоторый практический опыт работы с ним в том числе, дополнительно отмечу некоторые моменты:
 ...
 - перетасовывать папки и файлы внутри папки проекта (Git и SVN это допускают в отличие от CVS) нежелательно, как минимум их придется перепривязывать, а при обновлении кое-что можеть улететь и на репозитории, и в проекте,

...
Графические оболочки часто разрабатываются и применяются для разных прикладных задач, в том числе для работы с данными из СУБД. ВЭБ-сайт делается, чтобы что-то явить миру

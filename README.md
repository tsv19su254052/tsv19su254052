...
API-шки в своем широком понимании применяются для обеспечения работы модели "Клиент - Сервер" локально или по локальным сетям в библиотеках и пользовательских типах данных для многократного применения исходных текстов (статические и динамические библиотеки, технологии СОМ и DCOM) разной степени гибкости

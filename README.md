...
Можно попробовать совместную работу на [coda.io](https://coda.io/workspaces/ws-ga7Eabm46u/folders/fl-7OkuhzSo66?source=doc-title-bar) с пре-коммитами на инфраструктуре [Terraform](https://en.wikipedia.org/wiki/Terraform_(software)).

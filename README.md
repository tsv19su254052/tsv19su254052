...
В принципе практически все наработки являются прототипами и склоняются к циклу "Анализ - Дизайн - Разработка - Тестирование - Эксплуатация - Анализ", поэтому требуют постоянного совершенствования (UX/UI и CI/CD).

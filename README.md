...
С появлением вычислительной техники в 1990-х многие императивные и приближенные методы в математике с номограммами потеряли свою практическую пользу. Стало возможно посчитать аналитические формулы напрямую, используя конечно-разностные формы их записи. Посчитали многие прикладные математические задачи в том числе различные оптимизации, которые ждали своего решения еще с 1960-х годов. В основном решение получали в виде экстремума градиента на поверхности или на облаке точек.

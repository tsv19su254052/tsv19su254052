...
Если проект с доступом не по RDP, а по ВЭБ-мордочке, то можно попробовать совместную работу на [coda.io](https://coda.io/workspaces/ws-ga7Eabm46u/folders/fl-7OkuhzSo66?source=doc-title-bar) с пре-коммитами [Terraform](https://en.wikipedia.org/wiki/Terraform_(software)) на инфраструктуре облака. Вот [видео](https://www.youtube.com/watch?v=JC_OyWpqNSA) с примером на [Selectel](https://en.wikipedia.org/wiki/Selectel), который после ~~вождения за нос в 3-х соснах~~ знакомства с тарифами и опциями и с кластерами в [Kubernetes](https://en.wikipedia.org/wiki/Kubernetes) (надо рисовать проект, писать конфиги и манифесты на `yaml`-иках и все полностью закидывать туда), POD-ами, Node-ами на [Docker](https://en.wikipedia.org/wiki/Docker_(software))-е на каком-нибудь минималистичном Linux-е Вам в итоге таки предложат как вершину их сервиса просто отдельный сервер [VDS](https://www.reg.ru/vps/) с нормальной операционной системой Windows Server за балансировщиком на их IP-адресе.

...
Клиенты в локальной подсетке сидят на изолированных портах коммутатора и видны в сетевом окружении благодаря поднятой WINS. Но зайти на них не получается, поэтому самостоятельно расшаривать какие-то папки не рекомендуется.

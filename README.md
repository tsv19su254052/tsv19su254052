...
Много разрозненных наработок, использующих возможности только XML для работы с данными недоведены, устарели и ушли в пустоту.
...
no-SQL-ные СУБД по сравнению с SQL-ными имеют столько преимуществ сколько и неудобств, потому что являются продолжением темы JSON + двоичные поля и BLOB-ы в разных модификациях. Не заменят XML, так как есть принципиальное отличие:
 - XML - ветвление, топология, структура,
 - JSON, YAML - словарь, конфигурация, настройка

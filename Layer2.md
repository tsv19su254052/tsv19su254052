...
которые их парсят как [SAX](https://en.wikipedia.org/wiki/Simple_API_for_XML) и анализируют, изменяют и пишут как [DOM](https://en.wikipedia.org/wiki/Document_Object_Model).

...
Есть интересная библиотека [SQLAlchemy](https://docs.sqlalchemy.org/en/14/dialects/mssql.html#module-sqlalchemy.dialects.mssql.pyodbc) как слой абстракции в режиме [Core](https://docs.sqlalchemy.org/en/20/core) или в режиме [ORM](https://docs.sqlalchemy.org/en/20/orm/), но она пока умеет не очень сложные вещи. В начале ее разработки была надежда, что она даст функционал, позволяющий перенести вычислительную нагрузку с `SQL` на например `Python`, так как среды разработки на `Python`-е даже синтаксически не распознают вставки на `SQL`, а тем более вставки на `xPath&xQuery` внутри `SQL`.

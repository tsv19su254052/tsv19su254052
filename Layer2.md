...
Источников знаний по этим тонким и важным моментам море в основном как точки входа к платным курсам обучения и далее к приглашению о сотрудничестве, но там везде капают пипеткой. И надо понимать, что там как-то не торопятся дать решение, чтобы обойти конкретные затыки в продвижении, а скорее убедить, что их авторы нужны и важны и что наверное стоит передать наработки в их так сказать более опытные руки, для экономии времени и сил сразу перекинув все что есть со всеми пояснениями на их инфраструктуру (на облако).

...
Для `XML`-ных структур данных применяются:
 ...
 - [xProc](https://en.wikipedia.org/wiki/XProc) [💬](https://spec.xproc.org/3.1/xproc) [💬](https://www.w3.org/TR/xproc/)- более сложное конвейерное преобразование возможно в несколько шагов и в несколько путей с помощью вышеперечисленных, <!-- todo Там внутри функциональной достаточно сложная процедурная составляющая, надо поискать аналог в библиотеках на Python-е -->
...
<!-- 
todo Тут было бы неплохо дать графическую часть что во что входит, применяется и где используются одни и те же типы данных 
-->

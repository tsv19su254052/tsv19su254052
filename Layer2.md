...
todo Вообще все-таки надо выяснить: как пространства имен (типы данных и функции) доставляются с внешнего ресурса, за один раз или требуется постоянное подключение к этому внешнему ресурсу?

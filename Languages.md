...
Библиотека [tkvue](https://pypi.org/project/tkvue) [💬](https://gitlab.com/ikus-soft/tkvue) :
 ...
 - Своеобразна тем, что макет (эскиз) в виде разметки (мостик на WEB-разработку), можно вынести из исходника во внешний файл и на исполнении парсить его оттуда как SAX - некая доработка [XUL](https://ru.wikipedia.org/wiki/XUL).

...
Рисование макетов (эскизов) изначально не предусматривалось. Графика пишется сразу в исходниках на [Tk](https://en.wikipedia.org/wiki/Tk_(software)). Но позднее для их рисования и привязки к их виджетам скриптов на TCL применяется:

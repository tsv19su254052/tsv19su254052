[Tcl](https://www.tcl.tk/about/language.html "Делал некоторые графические оболочки с помощью среды разработки tkBuilder") [💬](https://en.wikipedia.org/wiki/Tcl "Описание"):
 - Применялся в середины 1990-х и в начале 2000-х на [ORACLE Solaris](https://en.wikipedia.org/wiki/Oracle_Solaris) для написания графических системных утилит.
 - Для привязки скриптов на TCL к виджетам на графических оболочках применялись [tkBuilder](https://sourceforge.net/projects/tkbuilder84/) (см. снимок экрана ниже), [Komodo](https://www.activestate.com/products/komodo-ide/) и [GUI Builder](https://spectcl.sourceforge.net/).
 - Начиная с `Tcl 8.5` появились темы - `ttk`.
...
[tk, ttk и ttk+](https://en.wikipedia.org/wiki/Tk_(software)) внутри [tkinter](https://en.wikipedia.org/wiki/Tkinter) :
 ...
 - Содержит встроенный интерпретатор `tcl` (мостик на TCL).

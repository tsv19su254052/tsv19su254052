...
Библиотека [tkvue](https://pypi.org/project/tkvue) [💬](https://gitlab.com/ikus-soft/tkvue) :
 ...
 - Своеобразна тем, что макет (эскиз) в виде XML-ной разметки можно вынести из исходника во внешний файл и на исполнении парсить его оттуда как SAX - некая доработка [XUL](https://ru.wikipedia.org/wiki/XUL), простой и нетрудоемкий мостик в WEB-разработку.
 - Дизайнера для рисования макетов (эскизов) графической оболочки пока не обнаружено. Поэтому большую сложность на нем поднять сложно. 
